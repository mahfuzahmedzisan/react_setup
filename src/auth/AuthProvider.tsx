...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const value = React.useMemo<AuthContextValue>(
    () => ({
      ...
      isAuthenticated:
        env.authStrategy === 'http_only_cookie' ? Boolean(user) : Boolean(accessTokenState),
      isSessionLoading,
      isUserLoading,
      user,
      setToken,
    ...
    [accessTokenState, isSessionLoading, isUserLoading, logout, refreshSession, setToken, user],
  );
